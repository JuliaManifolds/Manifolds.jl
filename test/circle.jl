...
@testset "Circle" begin
    ...
    @testset "Real Circle Basics" begin
        ...
        @test flat(M, 0.0, TFVector{ℝ}(1.0)) == CoTFVector{ℝ}(1.0)
        @test sharp(M, 0.0, CoTFVector{ℝ}(1.0)) == TFVector{ℝ}(1.0)
    ...
    @testset "Complex Circle Basics" begin
        ...
        @test flat(Mc, 0.0 + 0.0im, TFVector{ℝ}(1.0im)) ==
              CoTFVector{ℝ}(1.0im)
        @test sharp(Mc, 0.0 + 0.0im, CoTFVector{ℝ}(1.0im)) ==
              TFVector{ℝ}(1.0im)
