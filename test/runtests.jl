...
@testset "Manifolds.jl" begin
    ...
    include_test("manfiolds/centered_matrices.jl")
    include_test("manfiolds/circle.jl")
    include_test("manfiolds/cholesky_space.jl")
    include_test("manfiolds/elliptope.jl")
    include_test("manfiolds/euclidean.jl")
    include_test("manfiolds/fixed_rank.jl")
    include_test("manfiolds/generalized_grassmann.jl")
    include_test("manfiolds/generalized_stiefel.jl")
    include_test("manfiolds/grassmann.jl")
    include_test("manfiolds/hyperbolic.jl")
    include_test("manfiolds/lorentz.jl")
    include_test("manfiolds/multinomial_doubly_stochastic.jl")
    include_test("manfiolds/multinomial_symmetric.jl")
    include_test("manfiolds/positive_numbers.jl")
    include_test("manfiolds/probability_simplex.jl")
    include_test("manfiolds/projective_space.jl")
    include_test("manfiolds/rotations.jl")
    include_test("manfiolds/skewhermitian.jl")
    include_test("manfiolds/spectrahedron.jl")
    include_test("manfiolds/sphere.jl")
    include_test("manfiolds/sphere_symmetric_matrices.jl")
    include_test("manfiolds/stiefel.jl")
    include_test("manfiolds/symmetric.jl")
    include_test("manfiolds/symmetric_positive_definite.jl")
    include_test("manfiolds/symmetric_positive_semidefinite_fixed_rank.jl")
    include_test("manfiolds/tucker.jl")

    include_test("manfiolds/essential_manifold.jl")
    include_test("manfiolds/multinomial_matrices.jl")
    include_test("manfiolds/oblique.jl")
    include_test("manfiolds/torus.jl")

    #meta manifolds
    include_test("manfiolds/product_manifold.jl")
    include_test("manfiolds/power_manifold.jl")
    include_test("manfiolds/vector_bundle.jl")
    include_test("manfiolds/graph.jl")
