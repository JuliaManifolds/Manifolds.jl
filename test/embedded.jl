...
struct NotImplementedEmbeddedManifold2 <: AbstractEmbeddedManifold{AbstractIsometricEmbeddingType} end
...
@testset "Embedded Manifolds" begin
    ...
    @testset "PlaneManifold" begin
        ...
        @test project_point!(M,Q,P) == [1. 1. 0.]
    ...
    @testset "Test nonimplemented fallbacks" begin
        ...
        @testset "General Isometric Embedding Fallback Error Tests" begin
            ...
            @test_throws ErrorException vector_transport_direction(M2, [1,2], [2,3], [3,4])
            @test_throws ErrorException vector_transport_direction!(M2, A, [1,2], [2,3], [3,4])
