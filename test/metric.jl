...
ManifoldDistributions.projected_distribution(M::BaseManifold, d) = ManifoldDistributions.ProjectedPointDistribution(M, d, project!, rand(d))
ManifoldDistributions.projected_distribution(M::BaseManifold, d, x) = ManifoldDistributions.ProjectedPointDistribution(M, d, project!, x)
