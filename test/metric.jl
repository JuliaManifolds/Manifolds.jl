...
ManifoldDistributions.projected_distribution(M::BaseManifold, d) = ManifoldDistributions.ProjectedPoint(M, d, project!, rand(d))
ManifoldDistributions.projected_distribution(M::BaseManifold, d, x) = ManifoldDistributions.ProjectedPoint(M, d, project!, x)
