...
@decorator_transparent_signature get_coordinates(M::AbstractDecoratorManifold, p, X, B::VeeOrthogonalBasis)
...
@decorator_transparent_signature get_vector(M::AbstractDecoratorManifold, p, X, B::VeeOrthogonalBasis)
