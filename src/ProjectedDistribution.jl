...
function ProjectedFVectorDistribution(type::VectorBundleFibers, x, d::Distribution, project_vector!, xt::TResult) where TResult
    return ProjectedFVectorDistribution{TResult, typeof(type), typeof(x), typeof(d), typeof(project_vector!)}(type, x, d, project_vector!)
end
