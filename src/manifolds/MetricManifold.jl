...
decorator_transparent_dispatch(::typeof(exp!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(flat!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(get_basis), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(inner), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(inverse_retract!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(inverse_retract!), M::MetricManifold, X, p, q, m::LogarithmicInverseRetraction) = Val(false)
decorator_transparent_dispatch(::typeof(log!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(norm), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(project_point!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(project_tangent!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(sharp!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(retract!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(retract!), M::MetricManifold, q, p, X, m::ExponentialRetraction) = Val(false)
decorator_transparent_dispatch(::typeof(vector_transport_along!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(vector_transport_direction!), M::MetricManifold) = Val(false)
decorator_transparent_dispatch(::typeof(vector_transport_to!), M::MetricManifold) = Val(false)
