...
decorator_transparent_dispatch(M::MMT, ::typeof(inverse_retract!)) where {MMT <: MetricManifold} = Val(false)
...
decorator_transparent_dispatch(M::MMT, ::typeof(retract!)) where {MMT <: MetricManifold} = Val(false)
