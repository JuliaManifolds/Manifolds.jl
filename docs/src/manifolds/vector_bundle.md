...
It is characterized by a continuous function $\Pi \colon E → ℳ$, such that for each point $x \in ℳ$ the preimage of $x$ by $\Pi$, $\Pi^{-1}(\{x\})$, has a structure of a vector space.
