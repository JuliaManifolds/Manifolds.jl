...
We used the function [`manifold_volume`](@ref) to get the volume of the set over which integration is performed, as described in the linked Wikipedia article.
